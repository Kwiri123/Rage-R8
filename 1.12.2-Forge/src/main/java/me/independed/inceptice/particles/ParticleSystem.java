...
public class ParticleSystem {
    ...
    public void tick(int n) {
        ...
        this.particleList.forEach(particle -> ((Particle) particle).tick(n, 0.1f));
    }
    ...
    public void render() {
        ...
        for (Object particlew : this.particleList) {
            Particle particle = (Particle) particlew;
            ...
            for (Object particle3w : this.particleList) {
                Particle particle3 = (Particle) particle3w;
                float f2 = particle.getDistanceTo(particle3);
                if (f2 > (float) this.dist || this.distance(n, n2, particle.getX(), particle.getY()) > (double) this.dist && this.distance(n, n2, particle3.getX(), particle3.getY()) > (double) this.dist)
                    continue;
