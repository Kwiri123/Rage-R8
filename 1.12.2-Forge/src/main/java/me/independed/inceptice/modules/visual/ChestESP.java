...
public class ChestESP
    ...
    private void drawESPBoxes(float f) {
        ...
        for (Object entityw : this.ENTITIES) {
    ...
    public void onLocalPlayerUpdate(TickEvent.PlayerTickEvent playerTickEvent) {
        ...
        for (TileEntity tileEntity : Minecraft.getMinecraft().world.loadedTileEntityList) {
            ...
            if (tileEntity instanceof TileEntityChest) {
                ...
                TileEntityEnderChest tileEntityChest2 = (TileEntityEnderChest)tileEntity;
                axisAlignedBB = Minecraft.getMinecraft().world.getBlockState(tileEntityChest2.getPos()).getBoundingBox((IBlockAccess)Minecraft.getMinecraft().world, tileEntityChest2.getPos()).offset(tileEntityChest2.getPos());
            }
            this.TILE_ENTITIES.add(tileEntity);
            this.TILE_BOXES.add(axisAlignedBB);
        }
        this.ENTITIES.clear();
        for (Entity tileEntity : Minecraft.getMinecraft().world.loadedEntityList) {
            if (!(tileEntity instanceof EntityMinecartChest)) {
